function farfalla_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
farfalla_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				farfalla_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
farfalla_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
farfalla_xmlhttpRequester.prototype.setupRequestEvent =
